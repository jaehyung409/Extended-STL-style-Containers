...
namespace j {
export template <class T, class Container = deque<T>> class stack {
  public:
...
template <class InputIter> stack(InputIter, InputIter) -> stack<typename std::iterator_traits<InputIter>::value_type>;

template <class Container, class Allocator>
stack(Container, Allocator) -> stack<typename Container::value_type, Container>;

template <class InputIter, class Allocator>
stack(InputIter, InputIter, Allocator) -> stack<typename std::iterator_traits<InputIter>::value_type,
...
namespace j {
template <class T, class Container> stack<T, Container>::stack(const Container &cont) : _c(cont) {}

template <class T, class Container> stack<T, Container>::stack(Container &&cont) : _c(std::move(cont)) {}
