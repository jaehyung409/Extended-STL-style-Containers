...
namespace j {
export template <class T, class Container = deque<T>> class queue {
  public:
...
template <class Container> queue(Container cont) -> queue<typename Container::value_type, Container>;

template <class InputIter> queue(InputIter, InputIter) -> queue<typename std::iterator_traits<InputIter>::value_type>;

template <class Container, class Allocator>
queue(Container, Allocator) -> queue<typename Container::value_type, Container>;

template <class InputIter, class Allocator>
queue(InputIter, InputIter, Allocator) -> queue<typename std::iterator_traits<InputIter>::value_type,
...
namespace j {
template <class T, class Container> queue<T, Container>::queue(const Container &cont) : _c(cont) {}

template <class T, class Container> queue<T, Container>::queue(Container &&cont) : _c(std::move(cont)) {}
...
class priority_queue {
  ...
  public:
    ...
    void pop();
    void swap(priority_queue &pq) noexcept(std::is_nothrow_swappable_v<Container> &&
...
priority_queue(Compare, Container, Alloc) -> priority_queue<typename Container::value_type, Container, Compare>;
...
template <class T, class Container, class Compare>
priority_queue<T, Container, Compare>::priority_queue(const priority_queue &pq) : _c(pq._c), _comp(pq._comp) {}
...
template <class T, class Container, class Compare> void priority_queue<T, Container, Compare>::push(value_type &&x) {
    _c.push_back(std::move(x));
    push_heap(_c.begin(), _c.end(), _comp);
}
